...
This problem can be solved by segment tree. The main thing is to design the merge function for two nodes of a segment tree. It is shown in the code below.
